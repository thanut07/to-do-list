    ...
    <Fragment>
      <div className="relative">
        ...
        {textarea ? (
          <textarea
            id={name}
            className={`h-full ${className} disabled:input_disabled ${touched ? (error ? "input_error" : useForm ? "input_success" : "input_default") : "input_default"} ${textarea ? "" : "!h-10"}`}
            disabled={disabled}
            rows={rows}
            cols={50}
            autoComplete="off"
            ...
            <input
              ...
              className={
                ...
                (className
                  ...
                  : `${touched ? (error ? "input_error " : useForm ? "input_success !border-green-main" : "input_default") : `input_default ${iconsearch && "pl-10"}`} ${disabled ? (!error ? "input_disabled" : "input_disabled !border-red-500 text-red-500") : ""} ${textarea ? "" : "!h-10"
                  }`)
              }
              autoComplete="off"
          ...
          <div className="flex items-center">
            <input id={name} /* onBlur={onBlur} */ type={`${showPassword ? "text" : "password"}`} className={`${className} ${touched ? (error ? "input-border-is-invalid" : useForm ? "input-border-is-valid" : "field-input") : "field-input"}`} autoComplete="off" />
